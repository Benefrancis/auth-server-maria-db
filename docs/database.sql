...
-- Copiando dados para a tabela authdb.oauth_client_details: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela authdb.oauth_refresh_token: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela authdb.role_user: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela authdb.user: ~3 rows (aproximadamente)
DELETE FROM `user`;
